...
const data = {
	users: [
		{ name: 'Paul', email: 'admin@example.com', password: bcrypt.hashSync('1234', 8), isAdmin: true },
		{ name: 'John', email: 'admin@example.com', password: bcrypt.hashSync('1234', 8), isAdmin: false },
	],
	products: [
		{
